...
<script type="text/javascript" src="<%=path%>/component/jquery-outFetterTable_easy/jquery.outFetterTable.js"></script>
<script type="text/javascript">
    ...
    var __settings = {
        ...
        <%--loadURL: _PATH + '/workFlowController.do?method=getGeneralInfo&accountId=<%=accountId%>',--%>
        <%--loadURL: _PATH + '/workFlowController.do?method=getGeneralInfoList&processInstID=<%=processInstID%>',--%>
        loadURL: '<%=path%>/workFlowController.do?method=getGeneralInfoList&processInstID=<%=processInstID%>',
...
//        dtGridPager.highQueryParameters.le_datColumn1 = '';
        ...
        $.ajax({
            ...
            data: {
                dtGridPager: JsonObjectToString(dtGridPager),
