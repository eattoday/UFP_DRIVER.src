...
<script type="text/javascript">
    ...
    var __settings = {
        ...
        loadURL: _PATH + '/workFlowController.do?method=getWorkOrderStart&accountId=<%=accountId%>',
...
//            textAlign:"center",
            ...
            width: '10%',
            wrapFunction: function (record, __data_value) {
                return '<a style="text-decoration:underline"  onclick="sendMessage()" href="'
                    +_PATH + '/workFlowController.do?method=sendMessage' +
                    '&taskInstanceId=' + record.taskInstID +
                    '">' + '催办' + '</a>';
            }
